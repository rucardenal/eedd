...
void fCrearComplejo(float real, float imaginario, tComplejo *pComplejo) {
    pComplejo->real = real;
    pComplejo->imaginario = imaginario;
}
...
void fConjugado (tComplejo ncomplejo, tComplejo *pConjugado) {
    pConjugado->real = ncomplejo.real;
    pConjugado->imaginario = ncomplejo.imaginario * (-1);
}
...
void fRestar (tComplejo complejo1, tComplejo complejo2, tComplejo *pResta) {
    pResta->real = complejo1.real - complejo2.real;
    pResta->imaginario = complejo1.imaginario - complejo2.imaginario;
}
